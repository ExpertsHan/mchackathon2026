...
const APPLY_PRODUCT_MAP = {
  ...
  // (二) 影像類 AI
  "canva.com": "Canva Pro",
  "firefly.adobe.com": "Adobe Creative Cloud / Firefly",
  "adobe.com": "Adobe Creative Cloud / Firefly",
  "midjourney.com": "Midjourney Subscription",
  "figma.com": "Figma Professional / AI",

  // (三) 辦公類 AI
  "copilot.microsoft.com": "Microsoft Copilot Pro",
  "microsoft.com": "Microsoft Copilot Pro",
  "copy.ai": "Copy.ai Pro",
  "notion.so": "Notion AI",
  ...
  "speak.com": "Speak Premium",
  "elicit.com": "Elicit Plus",

  // (五) 其他類 AI
  "cursor.com": "Cursor Pro",
  "cursor.sh": "Cursor Pro",
};
...
function runAiSecurityCheck() {
  ...
  // 3. 【灰名單】未核准但常見/主流之 AI 工具與平台網域
  const graylistedAiDomains = [
    // 對話與搜尋 AI
    "poe.com", "pi.ai", "you.com", "kimi.moonshot.cn", "zhipuai.cn", "yiyan.baidu.com", "hunyuan.tencent.com",
    // 開發與程式碼 AI
    "replit.com", "v0.dev", "bolt.new", "codeium.com", "tabnine.com", "sourcegraph.com", "supermaven.com",
    // 圖像、影片與音樂生成 AI
    "leonardo.ai", "runwayml.com", "stability.ai", "dreamstudio.ai", "bfl.ml", "ideogram.ai", "seaart.ai",
    "recraft.ai", "krea.ai", "magnific.ai", "clipdrop.co", "pika.art", "lumalabs.ai", "haiper.ai", "veed.io",
    "heygen.com", "synthesia.io", "invideo.io", "suno.com", "suno.ai", "udio.com", "elevenlabs.io", "murf.ai", "play.ht",
    // 辦公、學術與生產力 AI
    "gamma.app", "tome.app", "otter.ai", "fireflies.ai", "descript.com", "taskade.com", "beautiful.ai",
    "consensus.app", "typeset.io", "researchrabbit.ai", "explainpaper.com", "chatpdf.com",
    // 模型託管與部署平台
    "huggingface.co", "replicate.com", "groq.com", "together.ai", "ollama.com", "fireworks.ai", "deepinfra.com", "anyscale.com",
    // 3D 與遊戲資產 AI
    "meshy.ai", "tripo3d.ai", "csm.ai", "sloyd.ai"
  ];
  ...
  // C. 檢查是否屬於【靜態灰名單】或【動態偵測到的未核准 AI 網站】
  const isGraylisted = graylistedAiDomains.some((domain) => hostMatches(currentHost, domain));
  const isUnapprovedAi = isGraylisted || detectUnapprovedAiSite();

  // 快取這次判斷結果，讓輸入內容偵測（performSecurityCheck）知道目前是不是 AI 網站
  siteIsAiRelated = isAllowed || isUnapprovedAi;

  // 如果目前網站對應到 demo 補助系統裡「已核准」的產品，顯示「立即申請補助」提示。
  if (isAllowed) {
    maybeShowApplySuggestion(currentHost);
  }

  // 如果屬於未核准的 AI（灰名單或動態偵測命中），且不在白名單內，顯示警告彈窗
    ...
    <div class="ai-sec-modal-overlay" style="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: rgba(0,0,0,0.65); z-index: 999999; display: flex; align-items: center; justify-content: center;">
      <div style="background: white; padding: 28px; border-radius: 12px; max-width: 500px; width: 90%; text-align: center; box-shadow: 0 10px 25px rgba(0,0,0,0.25);">
        ...
        <div style="margin-top: 24px; display: flex; gap: 10px; justify-content: center;">
          ...
          <a href="https://line.me/R/ti/p/%40188ulmdu" target="_blank" rel="noopener" style="display:inline-block; text-decoration: none; background-color: #00B900; color: white; border: none; padding: 10px 16px; border-radius: 6px; cursor: pointer; font-weight: bold;">
            💬 加 LINE 了解更多
          </a>
